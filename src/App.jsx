    ...
    <div>
      ...
      <main className="relative z-20 flex flex-col items-center justify-center h-[80vh]">
        ...
        <ul className="flex space-x-32 list-none">
          ...
          <li className="text-lg text-blue-500 flex items-center"><span className="inline-block w-2 h-2 bg-white rounded-full mr-3" aria-hidden="true"></span><Link to="/project3">Project 3</Link></li>
